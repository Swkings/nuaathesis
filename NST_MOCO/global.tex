...
\nuaaset{
  % thesisid = {1028716 22-S057},   % 论文编号
  thesisid = {***16 22-S057},   % 论文编号
  % title = {\nuaathesis{} 快速上手\linebreak 示例文档},
  title = {求解多目标旅行商问题的邻域结构迁移局部搜索算法的研究},
  author = {王康},
  college = {计算机科学与技术 学院},
  ...
  major = {计算机科学与技术},
  studentid = {SX1916059},
  classid = {计算机科学与技术},           % 班级的名称
  industrialadvisers = {Jack Ma}, % 企业导师，若无请删除或注释本行
  % 硕/博士
  majorsubject = {计算机科学与技术},
  researchfield = {计算智能理论与应用},
  libraryclassid = {TP391},       % 中图分类号
  subjectclassid = {081200},      % 学科分类号
}
\nuaasetEn{
  title = {Research on Local Search of Neighbor Structure Transfer for Solving Multi-objective Traveling Salesman Problem},
  author = {Kang Wang},
  college = {College of Computer Science and Technology},
  majorsubject = {Computer Science and Technology},
  advisers = {Associate Prof.~Xinye Cai},
