...
\begin{figure}[htb]
    \subfloat[聚类型 \label{subfig:聚类型}]{\includegraphics[width=.33\linewidth]{聚类型.pdf}}
    \subfloat[均匀分布型 \label{subfig:均匀分布型}]{\includegraphics[width=.33\linewidth]{均匀分布型.pdf}}
    \subfloat[真实数据 \label{subfig:真实数据}]{\includegraphics[width=.33\linewidth]{真实数据.pdf}}
...
\begin{figure}[!htb]
    \subfloat[meNS]{\includegraphics[width=.3\linewidth]{meNS时间对比.pdf}}
    \subfloat[K-NN]{\includegraphics[width=.3\linewidth]{meNS时间对比.pdf}} \\
    \subfloat[$\alpha$-nearest]{\includegraphics[width=.3\linewidth]{meNS时间对比.pdf}}
    \subfloat[Delaunay]{\includegraphics[width=.3\linewidth]{meNS时间对比.pdf}}
